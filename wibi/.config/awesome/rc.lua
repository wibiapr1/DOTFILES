...
naughty.config.defaults['font'] = 'Fira Sans Medium 20'
naughty.config.defaults['fg'] = '#bd93f9'
...
globalkeys = my_table.join(
    ...
    awful.key({ modkey1, altkey   }, "e", function() awful.util.spawn( "geany" ) end,
        {description = "Geany", group = "alt+ctrl"}),
    ...
    -- screenshots
    awful.key({ }, "Print", function() awful.spawn.with_shell("$HOME/.config/awesome/scripts/screenshot --now") end,
        {description = "Scrot", group = "screenshots"}),
    awful.key({ "Shift"             }, "Print", function() awful.spawn.with_shell("$HOME/.config/awesome/scripts/screenshot --area") end,
        {description = "maim", group = "screenshots"}),
    awful.key({ modkey1             }, "Print", function() awful.spawn.with_shell("$HOME/.config/awesome/scripts/screenshot --win") end,
        {description = "maim", group = "screenshots"}),
    awful.key({ altkey              }, "Print", function() awful.spawn.with_shell("$HOME/.config/awesome/scripts/screenshot --in5") end,
        {description = "scrot", group = "screenshots"}),
...
--]]
    ...
    -- ALSA volume control
    awful.key({ }, "XF86AudioRaiseVolume", function() awful.spawn.with_shell("$HOME/.config/awesome/scripts/volume --inc") end,
        {description = "Volume Up", group = "Volume"}),
    awful.key({ }, "XF86AudioLowerVolume", function() awful.spawn.with_shell("$HOME/.config/awesome/scripts/volume --dec") end,
        {description = "Volume Down", group = "Volume"}),
    awful.key({ }, "XF86AudioMute", function() awful.spawn.with_shell("$HOME/.config/awesome/scripts/volume --toggle") end,
...
awful.rules.rules = {
    ...
    { rule_any = {
        ...
        role = {
          ...
          -- Floating clients size setting but centered in screen
    { rule_any = {
       	class = {
		"Pavucontrol"
				},
      	...
      	properties = { floating = true },
    		  ...
    		  c:geometry({ width = 1000, height = 400 })
       		end },
    ...
    { rule_any = {
		...
		"Ristretto"
      	...
      	properties = { floating = true },
	      	callback = function (c)
                  awful.placement.centered(c,nil)
    		  c:geometry({ width = 1200, height = 800 })
       		end },
...
awful.spawn.with_shell("~/.config/awesome/scripts/gtkthemes")
