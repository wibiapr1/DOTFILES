--[[
     ...
     Powerarrow Catppuccin Mocha Awesome WM theme
     github.com/lcpz
...
theme.font                                      = "Fira Sans Medium 13"
theme.taglist_font                              = "Fira Sans Bold 16"
   ...
   s.quake = lain.util.quake({ app = "urxvt", height = 0.50, argname = "--name %s" })
    ...
    s.mywibox:setup {
        ...
        { -- Right widgets
            ...
            -- using separators
            arrow("#282a36", "#6272a4"),
            wibox.container.background(wibox.container.margin(wibox.widget { volicon, theme.volume.widget, layout = wibox.layout.align.horizontal }, dpi(2), dpi(3)), "#6272a4"),
            arrow("#6272a4", "#44475a"),
            wibox.container.background(wibox.container.margin(wibox.widget { memicon, mem.widget, layout = wibox.layout.align.horizontal }, dpi(2), dpi(3)), "#44475a"),
            arrow("#44475a", "#6272a4"),
            wibox.container.background(wibox.container.margin(wibox.widget { cpuicon, cpu.widget, layout = wibox.layout.align.horizontal }, dpi(3), dpi(4)), "#6272a4"),
            arrow("#6272a4", "#44475a"),
            wibox.container.background(wibox.container.margin(wibox.widget { nil, net.widget, layout = wibox.layout.align.horizontal }, dpi(3), dpi(3)), "#44475a"),
            arrow("#44475a", "#6272a4"),
            wibox.container.background(wibox.container.margin(clock, dpi(4), dpi(8)), "#6272a4"),
            arrow("#6272a4", "#282a36"),
